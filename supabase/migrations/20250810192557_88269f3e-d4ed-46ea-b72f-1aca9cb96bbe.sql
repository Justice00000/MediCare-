...
CREATE TYPE public.user_role AS ENUM ('patient', 'medical_practitioner');
...
CREATE TABLE public.profiles (
  ...
  last_name TEXT,
  phone TEXT,
  specialization TEXT, -- For medical practitioners
  license_number TEXT, -- For medical practitioners
  bio TEXT,
  avatar_url TEXT,
